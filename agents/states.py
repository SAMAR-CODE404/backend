...
class MnAagentState(BaseModel):
    ...
    # Reports
    fin_report_a: Optional[str] = Field(default=None, description="Filename of the final report for company A")
    fin_report_b: Optional[str] = Field(default=None, description="Filename of the final report for company B")
    ops_report_a: Optional[str] = Field(default=None, description="Operations report for company A")
    ops_report_b: Optional[str] = Field(default=None, description="Operations report for company B")
    legal_report_a: Optional[str] = Field(default=None, description="Filename of the legal report for company A")
    legal_report_b: Optional[str] = Field(default=None, description="Filename of the legal report for company B")
    merger_report: Optional[str] = Field(default=None, description="Filename of the merger report")
    competition_report: Optional[str] = Field(default=None, description="Filename of the competition report")
